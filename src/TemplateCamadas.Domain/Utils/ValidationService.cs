...
public abstract class ValidationService
{
    ...
    protected bool ExecuteValidations<TValidation, TModel>(TValidation validation, TModel model) where TValidation : AbstractValidator<TModel> where TModel : class
    {
        if (model is null)
        {
